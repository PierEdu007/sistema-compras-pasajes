  ...
  (
    ...
    '{
      "filas": [
        ...
        {"fila": 2, "asientos": [{"n": 3, "pos": "izq"}, {"n": 4, "pos": "cen"}, {"n": 5, "pos": "der"}], "nota": "Fila Trasera"}
      ]
    }'::JSONB
  ),
  (
    ...
    '{
      "filas": [
        {"fila": 1, "asientos": [{"n": 1, "pos": "izq"}, {"n": 2, "pos": "der"}], "nota": "Conductor + Copiloto"},
        {"fila": 2, "asientos": [{"n": 3, "pos": "izq"}, {"n": 4, "pos": "cen"}, {"n": 5, "pos": "der"}], "nota": "Fila Central"},
        {"fila": 3, "asientos": [{"n": 6, "pos": "izq"}, {"n": 7, "pos": "der"}], "nota": "Fila Trasera"}
      ]
    }'::JSONB
  );
